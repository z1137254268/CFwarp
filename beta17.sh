...
on) 
WARPIPv4Status=$(green "WARP已开启,当前IPV4地址：$v4$gj4 ") 
;; 
off) 
WARPIPv4Status=$(yellow "WARP未开启，当前IPV4地址：$v4$gj4 ") 
esac 
else
...
on) 
WARPIPv6Status=$(green "WARP已开启,当前IPV6地址：$v6$gj6 ") 
;; 
off) 
WARPIPv6Status=$(yellow "WARP未开启，当前IPV6地址：$v6$gj6 ") 
esac 
else
